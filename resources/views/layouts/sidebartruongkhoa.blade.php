  ...
  <ul class="nav flex-column">
    ...
    <!-- Chương trình & Học phần -->
     <li class="nav-item">
      ...
      <ul class="submenu">
        <li><a class="nav-link" href="{{ route('truongkhoa.chuongtrinhhocphan.chuongtrinh') }}">Chương trình đào tạo</a></li>
    ...
    <!-- Lịch thi & Coi thi -->
      ...
      <ul class="submenu">
        ...
        <li><a class="nav-link" href="{{ route('truongkhoa.lichthicoithi.coithi') }}">Giảng viên Coi thi</a></li>
