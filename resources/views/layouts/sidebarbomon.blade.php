  ...
  <ul class="nav flex-column">
        ...
        <li class="nav-item">
            ...
            <ul class="submenu" id="phanCongGV">
                <li><a class="nav-link" href="{{ route('truongbomon.quanlygiangvien.dsgiangvien') }}">Danh sách giảng viên</a></li>
                <li><a class="nav-link" href="{{ route('truongbomon.quanlygiangvien.phanconggiangday') }}">Phân công giảng dạy</a></li>
                <li><a class="nav-link" href="{{ route('truongbomon.quanlygiangvien.theodoitiendo') }}">Theo dõi tiến độ</a></li>
            </ul>
        </li>
        ...
        <li class="nav-item">
            ...
            <ul class="submenu" id="monHocBoMon">
                <li><a class="nav-link" href="{{ route('truongbomon.quanlyhocphan.dshocphan') }}">Danh sách học phần</a></li>
            </ul>
        </li>
        ...
        <li class="nav-item">
            ...
            <ul class="submenu" id="thiBoMon">
                <li><a class="nav-link" href="{{ route('truongbomon.dexuathi.dexuatlichthi') }}">Đề xuất lịch thi</a></li>
        ...
        <li class="nav-item">
            ...
            <ul class="submenu" id="duyetBaoCao">
                <li><a class="nav-link" href="{{ route('truongbomon.duyetbaocao.hopchuyenmon') }}">Duyệt họp chuyên môn</a></li>
                <li><a class="nav-link" href="{{ route('truongbomon.duyetbaocao.klcongviec') }}">Duyệt khối lượng công việc</a></li>
                <li><a class="nav-link" href="{{ route('truongbomon.duyetbaocao.bcketthuchocphan') }}">Duyệt báo cáo kết thúc học phần</a></li>
            </ul>
        </li>
