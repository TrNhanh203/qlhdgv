...
<head>
    ...
    <title>@yield('title', $university->universities_name ?? 'Hệ thống Quản lý Đại học')</title>
    ...
    <style>
        ...
        body.dark-mode .sidebar {
            background: linear-gradient(to bottom, #2b2b4f, #1a3a3a);
        }
        ...
        <div class="header">
            ...
            <div class="user">
                <a href="#" class="d-flex align-items-center text-decoration-none dropdown-toggle"
                    ...
                    <span class="me-2">{{ $user->name ?? 'Admin Trường' }}</span>
                    <img src="{{ $user->avatar ? asset('storage/' . $user->avatar) : 'https://i.pravatar.cc/100' }}"
                        alt="Avatar" class="rounded-circle" style="width:32;height:32;object-fit:cover;"
