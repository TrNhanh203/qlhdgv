...
<div class="container">
    <h1 style="font-size:24px; text-align: center; font-weight:700; margin-bottom:24px; ">
        📜 Nhật ký hệ thống
    </h1>
    ...
    @foreach ($roles as $roleKey => $roleName)
        <div class="log-section">
            ...
            <table>
                ...
                <tbody>
                    @php
                        $roleLogs = $logs->filter(fn($log) => $log->user && $log->user->role === $roleKey);
                    @endphp

                    @forelse ($roleLogs as $log)
                        <tr>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" style="color:#6b7280; font-style:italic;">
                                Không có dữ liệu
                            </td>
                        </tr>
                    @endforelse
