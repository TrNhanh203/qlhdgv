...
@section('content')
    ...
    <div class="panel" id="metaPanel">
        ...
        <div class="row flex">
            <div class="grow">
                ...
                <input type="text" id="tpl_code" placeholder="VD: CNTT-DC-2025">
            </div>
            <div class="grow">
            ...
            <div style="display:flex;align-items:flex-end;gap:8px">
                <div>
                    <label>&nbsp;</label><br>
                    <input type="checkbox" id="tpl_is_default"> <span>Đặt làm mẫu mặc định</span>
                </div>
                <div class="rightActions">
                    <button class="btn btn-outline-primary" id="openSaveModal">💾 Lưu thành mẫu…</button>
                </div>
            </div>
        </div>
        <div class="row">
    ...
    <div class="page" id="editorPage">
        ...
        <div class="header">
            <div class="left">
                <div class="line bold" contenteditable="true" id="gov_header" style="font-size:15px">UBND TP. HỒ CHÍ MINH
                </div>
                <div class="line bold" contenteditable="true" id="university_name" style="font-size:15px">TRƯỜNG ĐẠI HỌC THỦ
                    DẦU MỘT</div>
            </div>
            <div class="right">
                <div class="line bold" contenteditable="true" id="national_header" style="font-size:15px">CỘNG HÒA XÃ HỘI
                    CHỦ NGHĨA VIỆT NAM</div>
                <div class="line italic" contenteditable="true" id="national_motto" style="font-size:15px">Độc lập - Tự do -
                    Hạnh phúc</div>
            </div>
        </div>

        <div class="main-title" contenteditable="true" id="main_title">ĐỀ CƯƠNG CHI TIẾT HỌC PHẦN</div>
        <div class="major-title" contenteditable="true" id="major_name">NGÀNH: KỸ THUẬT PHẦN MỀM</div>
        ...
        <div id="sectionContainer">
            ...
            background:#f9fafb;border:1px solid #d1d5db;border-radius:6px;padding:4px 0;">
                    ...
                    <input type="text" class="sec-title" placeholder="Tiêu đề (title)" value="1. Thông tin tổng quát">

                    {{-- <label style="display:flex;align-items:center;gap:6px">
                        <input type="checkbox" class="sec-ref"> <span>is_reference</span>
                    </label> --}}
                    <div class="rightActions">
            ...
            {{-- <div class="section" data-id="2">
                <div class="section-header">
                    <input type="text" class="sec-code" placeholder="Mã mục (code) – VD: S02" value="S02">
                    <input type="text" class="sec-title" placeholder="Tiêu đề (title)" value="2. Mô tả học phần">
                    <input type="text" class="order order_no" value="2">
                    <label style="display:flex;align-items:center;gap:6px"><input type="checkbox" class="sec-ref">
                        <span>is_reference</span></label>
                    <div class="rightActions">
                        <button class="btn-ghost btnMoveUp">↑</button>
                        <button class="btn-ghost btnMoveDown">↓</button>
                        <button class="btn-ghost btnClone">⧉</button>
                ...
                <div class="section-content mt-1" contenteditable="true">Nội dung chi tiết...</div>
            </div>

            <div class="section" data-id="3">
                <div class="section-header">
                    <input type="text" class="sec-code" placeholder="Mã mục (code) – VD: S03" value="S03">
                    <input type="text" class="sec-title" placeholder="Tiêu đề (title)"
                        value="3. Mục tiêu học phần (CO)">
                    <input type="text" class="order order_no" value="3">
                    <label style="display:flex;align-items:center;gap:6px"><input type="checkbox" class="sec-ref">
                        <span>is_reference</span></label>
                    <div class="rightActions">
                        <button class="btn-ghost btnMoveUp">↑</button>
            ...
            <div class="section" data-id="4">
                <div class="section-header">
                    <input type="text" class="sec-code" placeholder="Mã mục (code) – VD: S04" value="S04">
                    <input type="text" class="sec-title" placeholder="Tiêu đề (title)" value="4. Nguồn học liệu">
                    <input type="text" class="order order_no" value="4">
                    <label style="display:flex;align-items:center;gap:6px"><input type="checkbox" class="sec-ref">
                        <span>is_reference</span></label>
                    <div class="rightActions">
                        <button class="btn-ghost btnMoveUp">↑</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" id="confirmSave">Lưu nháp (console)</button>
                </div>
            </div>
        </div>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById('confirmSave').addEventListener('click', async () => {
                try {
                    ...
                    const res = await fetch("{{ route('outline-templates.store') }}", {
                        method: "POST",
                        headers: {
