    ...
    public function dashboard()
{
    ...
    return view('admin.dashboard', compact(
        'semestersByYear','university', 'user', 'universityLogo', 'universityDescription',
        'stats', 'giangVienTheoKhoa', 'giangVienTheoBoMon', 'kyThiTheoNam',
        'coursesBySemester', 'lecturersAssignedByCourse',
        'lecturersByDept', 'departmentsByFaculty','universityCodeShort','coursesByYearSemester',
        'semestersListByYear'
    ));
}
...
public function update(Request $request, $id)
{
    ...
    $university->update($request->only([
        'university_name', 'university_type', 'address', 'phone', 
        'email', 'website', 'fanpage', 'founded_date', 'status_id', 'description'
    ]));
...
public function updateUniversity(Request $request, $id)
{
    try {
        ...
        $fields = [
            'university_name','university_type','address','phone','email',
            'website','fanpage','founded_date','status_id','description'
        ];
