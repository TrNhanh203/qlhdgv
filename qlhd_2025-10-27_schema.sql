...
CREATE TABLE IF NOT EXISTS `courses` (
  ...
  `outline_status` enum('none','draft','review','approved') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'none',
...
CREATE TABLE IF NOT EXISTS `outline_program_courses` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `outline_program_courses_program_version_id_foreign` (`program_version_id`),
  KEY `outline_program_courses_course_id_foreign` (`course_id`),
  CONSTRAINT `outline_program_courses_course_id_foreign` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`),
  CONSTRAINT `outline_program_courses_program_version_id_foreign` FOREIGN KEY (`program_version_id`) REFERENCES `outline_program_versions` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
