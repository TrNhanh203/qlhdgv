...
CREATE TABLE IF NOT EXISTS `courses` (
  ...
  CONSTRAINT `courses_outline_fk` FOREIGN KEY (`last_outline_version_id`) REFERENCES `outline_course_versions` (`id`) ON DELETE SET NULL,
  CONSTRAINT `courses_program_fk` FOREIGN KEY (`education_program_id`) REFERENCES `education_programs` (`id`) ON DELETE SET NULL
...
-- Dumping structure for table qlhd.outline_courses
DROP TABLE IF EXISTS `outline_courses`;
CREATE TABLE IF NOT EXISTS `outline_courses` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `course_id` bigint unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `outline_courses_course_id_foreign` (`course_id`),
  CONSTRAINT `outline_courses_course_id_foreign` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `outline_course_versions` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `outline_course_id` bigint unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `outline_course_versions_outline_course_id_foreign` (`outline_course_id`),
  CONSTRAINT `outline_course_versions_outline_course_id_foreign` FOREIGN KEY (`outline_course_id`) REFERENCES `outline_courses` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `outline_program_courses` (
  ...
  `program_version_id` bigint unsigned NOT NULL,
  `course_id` bigint unsigned NOT NULL,
  `knowledge_type` enum('kien_thuc_chung','kien_thuc_khoa_hoc_co_ban','kien_thuc_bo_tro','kien_thuc_co_so_nganh_lien_nganh','kien_thuc_chuyen_nganh','do_an_thuc_tap') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  CONSTRAINT `opc_program_version_fk` FOREIGN KEY (`program_version_id`) REFERENCES `program_versions` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `outline_section_templates` (
  ...
  `default_content` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
